...
switch argument0
{
    ...
    case 1: //workbench items
    {
        switch argument1
        {
            case 0: { text[0] = "Green Sword"; text[1] = "Damage: 6#Speed: 2"; text[2] = "Copper Ore x 20#Stick x 5"} break; //Green Sword
            case 1: { text[0] = "Green Pickaxe"; text[1] = "Tier: 0#Speed: 2"; text[2] = "Copper Ore x 15#Stick x 5" } break; //Green Pick
            ...
            case 4: { text[0] = "Gremlin Talisman"; text[1] = "Consumable"; text[2] = "Stone Piece x 50#Synthetic Essence x 5" } break;
