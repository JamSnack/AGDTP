...
{    
    ...
    //Dull Sword
    case ITEMID.weapon_starter: { toolAnimation = "STAB"; tool_firerate = 34; proj_spd = 3.5; proj_dec = 40; tool_spr = spr_sword; proj_spr = hbox_sword; wep_Dam = 4; wep_Knock = 3.25; proj_type = 0; tool_snd = swish;} break;
