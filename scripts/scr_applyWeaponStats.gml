...
{    
    //Green Sword
    case ITEMID.weapon_greenSword: { toolAnimation = "STAB"; tool_firerate = 30; proj_spd = 3.5; proj_dec = 35; tool_spr = spr_swordGreen; proj_spr = hbox_sword; wep_Dam = 6; wep_Knock = 3.5; proj_type = 0;} break;
    ...
    case ITEMID.weapon_subLimeMachineGun: { toolAnimation = "SHOOT"; tool_firerate = 10; proj_spd = 8; proj_dec = 0; tool_spr = spr_subLimeMachineGun; proj_spr = spr_bullet; wep_Dam = 3; wep_Knock = 0.02; proj_type = 2;} break;
    case ITEMID.weapon_sphereLauncher: { toolAnimation = "SHOOT"; tool_firerate = 45; proj_spd = 3; proj_dec = 0; tool_spr = spr_sphereLauncher; proj_spr = spr_sphere; wep_Dam = 4; wep_Knock = 0.1; proj_type = "SPHERE";} break;
}
