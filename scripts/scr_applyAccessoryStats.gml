...
if instance_exists(obj_player)
{
    ...
    {    
        ...
        case ITEMID.acc_copperSlingDrive: { obj_player.sling_force = 8*equip; obj_player.sling_jumps_set = 3*equip; obj_player.sling_jumps_remaining += 1*equip; obj_player.sling_cooldown_set = 60*equip; } break;
    }
}
