...
if instance_exists(obj_player)
{
    ...
    {    
        ...
        case ITEMID.acc_copperSlingDrive: { obj_player.sling_force = 4.5*equip; obj_player.sling_jumps_set = 1*equip; obj_player.sling_jumps_remaining += 1*equip; obj_player.sling_cooldown_set = 60*equip; } break;
    }
}
