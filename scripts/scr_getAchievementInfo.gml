...
switch _ach
{
    ...
    case ACHIEVEMENT.impenetrable: { _d[0] = "Impenetrable!"; _d[1] = "Place 250 tiles around the pie."; } break;
    ...
    case ACHIEVEMENT.fruity: { _d[0] = "Fruit Feller"; _d[1] = "Kill the Melon Bloom."; _d[2] = "Turret Capacity +1#Melonite Recipes Unlocked";} break;
